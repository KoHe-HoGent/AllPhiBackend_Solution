...
export const getRijbewijzen = (req, res) => {
...
export const getRijbewijs = (req, res) => {
    //controleer id
...
export const createRijbewijs = (req, res) => {
...
export const updateRijbewijs = (req, res) => {
...
//specifiek Rijbewijs ophalen uit database via id
export const getRijbewijsViaRijbewijstype = (req, res) => {
    //controleer id
    if (!_valideerId(req.params.id))
        res.status(400).send("id moet een positieve integer zijn");
