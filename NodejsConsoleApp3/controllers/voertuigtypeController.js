...
export const getVoertuigtypes = (req, res) => {
...
export const getVoertuigtype = (req, res) => {
    //controleer id
...
export const createVoertuigtype = (req, res) => {
    //insert query
    const _connection = mysql.createConnection(config);
...
export const updateVoertuigtype = (req, res) => {
    //valideer id
    if (!_valideerId(req.params.id))
        res.status(400).send("id moet een positieve integer zijn");
