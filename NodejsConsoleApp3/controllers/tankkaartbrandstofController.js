...
export const getTankkaartbrandstoffen = (req, res) => {
...
export const getTankkaartbrandstof = (req, res) => {
    //controleer id
...
export const createTankkaartbrandstof = (req, res) => {
    //insert query
    const _connection = mysql.createConnection(config);
...
export const updateTankkaartbrandstof = (req, res) => {
